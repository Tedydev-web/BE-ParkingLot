...
namespace ParkingLot.Infrastructure.Services
{
    public class GoongMapService : IGoongMapService
    {
        ...
        public async Task<IEnumerable<Place>> SearchPlacesAsync(string query, double? latitude = null, double? longitude = null)
        {
            // Implement the method
            throw new NotImplementedException();
        }
        ...
        public async Task<IEnumerable<double>> GetDistancesAsync(Location origin, IEnumerable<Location> destinations)
        {
            // Implement the method
            throw new NotImplementedException();
        }

        public bool ValidateAddress(string address, double latitude, double longitude)
        {
            // Implement the method
            throw new NotImplementedException();
        }
