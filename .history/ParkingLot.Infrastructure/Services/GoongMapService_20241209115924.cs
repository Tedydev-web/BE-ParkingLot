...
namespace ParkingLot.Infrastructure.Services
{
    ...
    {
        public GoongResult[] Results { get; set; }
    }
    ...
    {
        public GoongRow[] Rows { get; set; }
    }

    public class GoongRow
    {
        public GoongElement[] Elements { get; set; }
    }

    public class GoongElement
    {
        public GoongDistance Distance { get; set; }
    }
