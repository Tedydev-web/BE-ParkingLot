...
using GoongMap.SDK; // Added to resolve GoongMapClient
using ParkingLot.Core.DTOs; // Added if GeocodingResult is in DTOs
...
public class GoongMapService : IGoongMapService
{
    ...
    private readonly GoongMapClient _client; // Ensure GoongMapClient is referenced
        ...
        ILogger<GoongMapService> logger)
    {
        ...
        _client = new GoongMapClient(_apiKey); // Ensure GoongMapClient is properly instantiated
    }
