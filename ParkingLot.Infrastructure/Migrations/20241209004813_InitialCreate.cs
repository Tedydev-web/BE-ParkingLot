        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotTypeCapacity = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    BaseHourlyRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    HourlyRateByType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    HasOvernightParking = table.Column<bool>(type: "bit", nullable: false),
                    HasDisabledAccess = table.Column<bool>(type: "bit", nullable: false),
                    HasWashing = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ParkingLots_Location_LocationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ParkingLotId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PricesByVehicleType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PriceHistories_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingLots_LocationId",
                table: "ParkingLots",
                column: "LocationId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceHistories_ParkingLotId",
